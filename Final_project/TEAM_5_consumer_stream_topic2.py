...
# Filtering dataframe to include only tweets with hashtag and having topic as negative
filtered_df = spark.sql("SELECT * FROM tweets WHERE hashtags != '' AND topic = 'negative'")
