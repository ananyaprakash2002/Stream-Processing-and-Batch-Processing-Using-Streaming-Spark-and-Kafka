...
# Filtering dataframe to include only tweets with hashtag and having topic as neutral
filtered_df = spark.sql("SELECT * FROM tweets WHERE hashtags != '' AND topic = 'neutral'")
